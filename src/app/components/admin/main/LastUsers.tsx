...
const lastClicks = [
  { name: "Serkan", date: "14:58:13" },
  { name: "Ahmet", date: "14:58:13" },
  { name: "Veli", date: "14:58:13" },
  { name: "Esma", date: "14:58:13" },
  { name: "Fidan", date: "14:58:13" },
];
const labels = ["Kullanıcı Adı", "Zaman"];

function LastUsersCard() {
  return (
    <LastViewCard Icon={GrDocumentUser} label="Son Üyeler">
      {lastClicks?.length < 0 ? (
